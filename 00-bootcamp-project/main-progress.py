...
table = "events"
header = ["event_id", "session_id", "user_id", "event_type", "page_url", "created_at", "order_id", "product_id"]
with open(f"{DATA_FOLDER}/{table}.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(header)
...
table = "orders"
header = ["order_id", "promo_id", "user_id", "address_id", "created_at", "order_cost", "shipping_cost", "order_total", "tracking_id", "shipping_service", "estimated_delivery_at", "delivered_at", "status"]
with open(f"{DATA_FOLDER}/{table}.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerow(header)
